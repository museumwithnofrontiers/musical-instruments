...
The **Museum With No Frontiers — Musical Instruments** gallery, built from the published
dataset `@museumwnf/musical-instruments-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/musical-instruments-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/musical-instruments/> through the reusable workflows in
