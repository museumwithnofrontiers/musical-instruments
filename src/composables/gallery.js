...
// `useGalleryData.js` used to be byte-identical local copies of what musical-instruments
...
// legacy project key, no UUID — musical-instruments shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (musical-instruments-data 1.0.11+), an outside
