...
const about = {
  body: 'musicalInstruments.about.body',
...
export default {
  ...
  home: {
    title: 'musicalInstruments.identity.title',
    intro: 'musicalInstruments.home.intro',
    cards: [
      {
        title: 'musicalInstruments.nav.catalogue',
        description: 'musicalInstruments.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'musicalInstruments.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'musicalInstruments.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'musicalInstruments.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'musicalInstruments.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'musicalInstruments.partnerObjects.emptyPartner',
  //         emptyInstitution: 'musicalInstruments.partnerObjects.emptyInstitution',
  //         institutionSummary: 'musicalInstruments.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'musicalInstruments.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'musicalInstruments.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
