...
export default {
  ...
  // one entry for every project id `npm pack @museumwnf/musical-instruments-data`
  // carries in `manifest.projects` (checked 2026-09-19, musical-instruments-data 1.0.9).
  ...
  site: { origin: 'https://museumwithnofrontiers.github.io/musical-instruments' },
